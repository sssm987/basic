...
public class ProductController {
    ...
    public ResponseEntity<ResponseWrapper<List<ProductOrdersSelectResponseDTO>>> productOrdersSelect(){
        return ResponseEntity.ok(ResponseWrapper.of(productService.productOrdersSelect()));
    }
}
